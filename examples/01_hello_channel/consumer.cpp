...
// and acknowledges it.
//
// Demonstrates: eshm_init as SLAVE (including the retry a slave needs),
//               eshm_read_ex, ESHM_ERROR_TIMEOUT handling, eshm_write.
//
// Run:   ./hello_consumer [channel_name]      (start a publisher first)
//
// Pairs with ./hello_publisher or with `python3 peer.py publish <channel>`.
