...
//
// Demonstrates: eshm_default_config, eshm_init as MASTER, eshm_write,
//               eshm_read_ex with a timeout, eshm_error_string, eshm_destroy.
//
// Build: see CMakeLists.txt in this directory.
// Run:   ./hello_publisher [channel_name]
//
// The peer on the other end can be C++ or Python - the segment does not care:
//   ./hello_consumer demo                  |  python3 peer.py consume demo
